...
preferences {
    page(name: "mainPage", title: "Attribute Aggregator Configuration", install: isInstallable(), uninstall: true) {
        section("Devices") {
            ...
            input "mainDevice", "capability.sensor,capability.temperatureMeasurement", title: "Non-Battery-Powered Device(s)", required: true, multiple: true, submitOnChange: true
        }
        section("Settings") {
